// The description of each of the tables and columns is stored in a JSON object.
const jsonData = {
    "delivery_facts": {
...
function createColumnButtons(parentKey) {
    // When the table button is clicked, create buttons for each column in the table
    // This function is only working in the test table view, which happens when you send a GET request to the /vanna_table_view
